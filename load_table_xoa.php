        ...
        if (!$result) {
            ...
            echo "<form method='post' action='delete.php'>
                <table style='border: 1px solid black; border-collapse: collapse;'> 
                    <tr> 
                        ...
                        <th style='border: 1px solid black; padding: 10px;'>Xoa Nhan Vien </th> 
                    </tr>";
            ...
            while($row = $result->fetch_assoc()) {
                echo "<tr> 
                    ...
                    <td style='border: 1px solid black; padding: 10px;'><input type='checkbox' name ='tick[]' value='".$row["IDNV"]."'></td>
                </tr>";
            }
            echo "</table>";
            echo "</form>";
